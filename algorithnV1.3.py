...
gedgex = ansx*0.9#優良答案x座標
gedgey = ansy*0.9#優良答案y座標
gedgew = answ*1.03#優良答案寬度
gedgeh = ansh*1.03#優良答案高度

nedgex = ansx*0.7#普通答案x座標
nedgey = ansy*0.7#普通答案y座標
nedgew = answ*1.07#普通答案寬度
nedgeh = ansh*1.07#普通答案高度

gedgex2 = ansx*1.1#優良答案x座標
gedgey2 = ansy*1.1#優良答案y座標
gedgew2 = answ*0.97#優良答案寬度
gedgeh2 = ansh*0.97#優良答案高度

nedgex2 = ansx*1.3#普通答案x座標
nedgey2 = ansy*1.3#普通答案y座標
nedgew2 = answ*0.93#普通答案寬度
nedgeh2 = ansh*0.93#普通答案高度
...
'''
if gansltdis2<=ltdis<gansltdis and gansrtdis2<=rtdis<gansrtdis and ganslbdis2<=lbdis<ganslbdis and gansrbdis2<=rbdis<gansrbdis:
    level = '優'
elif nansltdis2<=ltdis<nansltdis and nansrtdis2<=rtdis<nansrtdis and nanslbdis2<=lbdis<nanslbdis and nansrbdis2<=rbdis<nansrbdis:
    level = '普通'
else :
    level = '劣'
'''
...
if ltdis<=gansltdis2 and rtdis<=gansrtdis2 and lbdis<=ganslbdis2 and rbdis<=gansrbdis2:
    level = '優'
